...
export default function AdminHabitaciones() {
  ...
  function cargar() {
    api.adminListarHabitaciones(idAlojamiento).then(setHabitaciones).catch((e) => setError(e.message));
  }

  useEffect(() => { cargar(); }, [idAlojamiento]);
  ...
  return (
    <div>
      ...
      <div className="card overflow-x-auto">
        ...
        {habitaciones.length === 0 && <p className="p-4 text-center text-stone-500">Este alojamiento no tiene habitaciones todavía.</p>}
      </div>
    </div>
  );
}
